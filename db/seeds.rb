...
Product.create!([
  ...
  {name: "White Out", description: "", price: 3.99, stock: 6, url: "white_out.jpeg", user_id: 2, retired: false},
  {name: "Tardis Dr. Who Time Machine", description: "Time machine capable of traveling any direction through space and time — so it can visit any planet at any point in history", price: 2300000000.0, stock: 1, url: "tardis_time_machine.jpg", user_id: 3, retired: false, categories: Category.where(name: "Time Machines")},
  ...
  {name: "Bad Credit Repair Service", description: "Fix your bad credit with our credit recovery service", price: 199.0, stock: 2, url: "credit_repair_service.jpg", user_id: 2, retired: false, categories: Category.where(name: "Lifestyle")},
